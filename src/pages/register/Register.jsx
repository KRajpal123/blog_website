                    ...
                    <form onSubmit={handleSubmit(submitHandler)}>
                        ...
                        <div className="flex flex-col mb-6 w-full">
                            ...
                            <input type="text" id='name'
                                {...register("name", {
                                    minLength: {
                                        value: 1,
                                        message: "Name length at least 1 Character"
                                    },
                                    required: {
                                        value: true,
                        ...
                        <div className="flex flex-col mb-6 w-full">
                            ...
                            <input type="text" id='email'
                                ...
                                className={`placeholder:text-[#959ead] text-dark-hard mt-3 rounded-lg px-5 py-4 
                                font-semibold block outline-none border ${errors.email ? "border-red-500" : "border-[#c3cad9]"
                                    }`}
                            />
                        ...
                        <button
                            ...
                            className="bg-primary text-white font-bold text-lg 
